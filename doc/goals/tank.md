...
Tank still have only one life.

## Setup

A special "tank" spawn has to be set. Just type [`/pa <arena> spawn tank`](../commands/spawn.md).

Optionally, you can give a special gear to the tank by [setting the class](../commands/class.md) `%tank%`. This class is auto-assigned 
to the tank player.

## Config settings

- `tank.tlives` \- the amount of lives players have before being removed (default: 1)
