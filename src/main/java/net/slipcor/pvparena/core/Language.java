...
public final class Language {
    ...
    public enum MSG {
        ...
        NOTICE_REWARDEDPLAYER("nulang.notice.rewardedplayer", "%1% has earned %2%."),
        ...
        MODULE_VAULT_NOACCOUNT("nulang.mod.vault.noaccount", "A bank account is required to use this command or play this arena."),
        MODULE_VAULT_THEYNOTENOUGH("nulang.mod.vault.theynotenough", "%1% doesn't have enough cash!"),
        ERROR_VAULT_BETTIMEOVER("nulang.mod.vault.bettimeover", "Betting time is over!"),
        ERROR_VAULT_BEFOREBETTIME("nulang.mod.vault.beforebettime", "Betting time is started yet! Please wait until beginning of the match."),
        MODULE_VAULT_BETNOTYOURS("nulang.mod.vault.betnotyours", "Cannot place bets on your own match!"),
        MODULE_VAULT_BETONLYTEAMS("nulang.mod.vault.betonlyteams", "You can only bet on (non-empty) teams!"),
        MODULE_VAULT_BETONLYPLAYERS("nulang.mod.vault.betonlyplayers", "You can only bet on players!"),
        ...
        MODULE_VAULT_BETPLACED("nulang.mod.vault.betplaced", "Your %1% bet on %2% has been placed."),
        MODULE_VAULT_BETCHANGED("nulang.mod.vault.betchanged", "Your bet has been changed. From now on, you bet %1% on %2%."),
        MODULE_VAULT_YOUEARNED("nulang.mod.vault.youearned", "You have earned %1%!"),
